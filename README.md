...
```bash
git clone https://github.com/YOUR-USERNAME/JSFrameworks2024.git
```
...
```bash
cd JSFrameworks2024
git remote add upstream https://github.com/AlbanyCanCodeCourses/JSFrameworks2024.git
git remote -v
# You should see your upstream set as https://github.com/AlbanyCanCodeCourses/JSFrameworks2024.git
