...
function DiceRoller() {
   ...
   */
  const [diceNumber, setDiceNumber] = useState(generateRandomDiceNumber()); // We start with a random number
  const rollDice = () => setDiceNumber(generateRandomDiceNumber()); // And update state by generating another random number
      ...
      <div className="d-inline-flex flex-row align-items-center">
        <h1 className="p-2 h3">
          ...
          <div>
            ...
            <button className="btn btn-primary btn-sm" onClick={rollDice}>
              Roll
            </button>
          </div>
        </h1>
